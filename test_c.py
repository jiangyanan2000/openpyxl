...
for files1 in s1:
    ...
    for each_rows in ws.rows:
        ...
        for cols in ws.iter_cols(min_col=3, min_row=2, max_col=maxcolumn, max_row=(maxrow + 1)):
            # print(cols)
...
for files4 in s4:
    ...
    # print(maxrow)
    # print(active_probablity)
    active_student = "D" + str(maxrow)
    # print(active_student)
    activate_student = "K" + str(maxrow)
    # print(activate_student)
    per_score = "C" + str(maxrow + 2)
    total_score = "I" + str(maxrow)
    # print(total_score)
    ...
    wb.save(files4)
wb_collect = load_workbook(r"C:\Users\jdbscwmsjs\Desktop\汇总.xlsx")
...
for files5 in s5:
    ...
    wb.close()
wb_collect.save(r"C:\Users\jdbscwmsjs\Desktop\汇总.xlsx")

wb_collect = load_workbook(r"C:\Users\jdbscwmsjs\Desktop\汇总.xlsx")
ws_collect = wb_collect["各社区汇总表"]

wb_lastweek = load_workbook(r"C:\Users\jdbscwmsjs\Desktop\lastweek.xlsx")
